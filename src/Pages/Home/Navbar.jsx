...
function Navbar() {
    ...
    <nav className={`navbar ${navActive ? "active" : ""}`}>
        <div>
            <img src="./img/Screenshot-2023-12-17-182909.svg" alt="Logoipsum"  className="navbar--svg"/>
        </div>
        ...
        <div className={`navbar--items ${navActive ? "active" : ""}`}>
            <ul>
                ...
                <li>
                    <Link onClick={closeMenu} activeClass="navbar--active-content" spy={true} smooth={true} offset={-70} duration={500} to="testimonial" className="navbar--content">Testimonial</Link>
                </li>
            </ul>
        </div>
